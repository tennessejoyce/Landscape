...
#Load ids of images that were successfully downloaded.
with open('good_images.p','rb') as f:
	good_images = pickle.load(f)
#Sort the ids alphebetically, to match the order of the Pytorch DataLoader.
good_images.sort()
...
#Objects for loading the images in 
...
#Add the auxilliary features, and save to a file.
